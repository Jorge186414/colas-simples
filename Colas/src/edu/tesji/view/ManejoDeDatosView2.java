...
public class ManejoDeDatosView2 extends JFrame {
	...
	// Con las siguientes lineas de codigo nuestra interfas se va a lanzar o mostrar
	// en pantalla
	// colocando toda la sintaxis en el metodo principal declarando
	...
	public ManejoDeDatosView2() {
		...
		btnAgregar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					// En caso de que el try detecte un error, mediante un JOptionPane se mostrara
					// un mensaje para verificar los datos
		...
		btnSalir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// Al presionar el boton Salir de la interfaz o la x, se mandara a llamar al
				// metodo salir el cual se encargara
		...
		btnNuevo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				/*
				 * Si presionamos el boton nuevo se borrara el valor que hay en txtNuevo
				 * mandandole un valor null y al mismo tiempo el cursor se colocara en este
				 * mismo TextField para hacer mas rapido el ingreso de datos
				 */
